...
// TODO: parse the parameters with zod
      ...
      <div className="grid grid-cols-6 -mt-20 gap-20 items-start">
        ...
        <div className="col-span-2 space-y-5 mt-32 p-6 sticky top-20 border rounded-lg">
          <div className="flex flex-col">
            ...
            <span className="text-2xl font-medium">{loaderData.job.salary_range}</span>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex">
            ...
            {/* TODO: track views */}
            <span className="text-sm text-muted-foreground">333 views</span>
          </div>
